          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Share your thoughts and ideas with the world through our modern blogging platform. Connect with readers and writers from around the globe.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/all-posts" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                    All Posts
                  </Link>
                </li>
                <li>
                  <Link to="/add-post" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                    Create Post
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/signup" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                    Sign Up
                  </Link>
                </li>
              </ul>
